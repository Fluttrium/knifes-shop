        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-3">
              {/* ВК */}
              <Link href="https://vk.com" aria-label="VK" className="text-gray-400 hover:text-white transition-colors">
              ...
              {/* Telegram */}
              <Link href="https://t.me" aria-label="Telegram" className="text-gray-400 hover:text-white transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/knives" className="text-gray-300 hover:text-white transition-colors">
                  Кухонные ножи
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/sharpening" className="text-gray-300 hover:text-white transition-colors">
                  Заточка ножей
                </Link>
              </li>
              <li>
                <Link href="/sets" className="text-gray-300 hover:text-white transition-colors">
                  Наборы ножей
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">Санкт-Петербург</span>
              </div>
              <div className="flex items-center space-x-3">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2024 Ножи СПБ. Все права защищены.
            </p>
