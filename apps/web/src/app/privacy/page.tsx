    ...
    <main className="container mx-auto max-w-3xl px-4 py-12 space-y-8">
      ...
      <section className="space-y-4">
        ...
        <p>
          ...
          интернет‑магазина Knife&apos;s Shop (далее — «Сайт»).
        </p>
      </section>
      ...
      <section className="space-y-4">
        ...
        <ul className="list-disc pl-6 space-y-1">
          ...
          <li>
            Технические данные: IP‑адрес, информация о браузере и устройстве,
            файлы cookie, данные о сессиях и действиях на Сайте.
          </li>
      ...
      <section className="space-y-4">
        ...
        <p>
          Мы используем файлы cookie и аналогичные технологии для корректной
          работы Сайта, анализа трафика и персонализации. Вы можете изменить
          настройки cookie в браузере, но это может повлиять на
          функциональность.
        </p>
      </section>
      ...
      <section className="space-y-4">
        ...
        <p>
          Данные хранятся в защищённых средах и обрабатываются с использованием
          современных методов защиты. Доступ ограничен уполномоченными лицами.
      ...
      <section className="space-y-4">
        ...
        <p>
          Мы можем передавать данные логистическим партнёрам, платёжным
          провайдерам, сервисам аналитики — исключительно для целей, указанных в
          Политике, и на основании договоров о конфиденциальности и обработке
          данных.
        </p>
      </section>
      ...
      <section className="space-y-4">
        ...
        <p>
          ...
          <a
            ...
            href="mailto:support@knifes-shop.com"
          >
            fluttrium@gmail.com
          </a>
          .
      ...
      <section className="space-y-4">
        ...
        <p>
          Мы можем обновлять Политику. Новая редакция вступает в силу с момента
          публикации на Сайте. Рекомендуем периодически просматривать эту
          страницу.
        </p>
      </section>
